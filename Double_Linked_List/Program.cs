...
namespace Double_Linked_List
{
    ...
    class DoubleLinkedList
    {
        ...
        public void retraverse()
        {
            ...
            {
                Console.WriteLine("\nRecords in the descending order of " + "roll number are:\n");
                Node currentNode;
            ...
            while (true)
            {
                try
                {
                    Console.WriteLine("\n Menu" +
                        ...
                        "\n 2. Delete a record form the list" +
                        "\n 3. View all records in the ascending order of the roll numbers" +
                        "\n 4. View all records in the descending order of the roll numbers" +
                        "\n 5. Search for ad record in the list" +
                        "\n 6. Exit \n" +
